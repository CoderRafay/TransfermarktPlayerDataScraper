...
def convert_market_value(market_value, remove_euro_sign, convert_to_expanded_form):
    ...
    if convert_to_expanded_form:
        # Use regular expression to identify "X.XXK" or "X.XXM" format
...
def extract_players_data(url, selected_fields, remove_euro_sign, convert_to_expanded_form):
    ...
    for row in player_rows:
        ...
        if 'Name' in selected_fields:
            ...
            name = name_element["title"].strip() if name_element else "N/A"
        ...
        if 'Nationality' in selected_fields:
            ...
            nationality = nationality_element["title"] if nationality_element else "N/A"
...
# Set Default Icon
icon_path = "Transfermarkt_favicon.png"  # Change to the correct file path if needed
...
# Options for removing € sign and converting to expanded form
